 ...
 */
function limitMaxText(limitField) {
    var limitNum =300;
            ...
            creditcard: function(value, element) {
                ...
                if (type.length > 0 && type != null && type != undefined &&
                   cardnumber != null && cardnumber != undefined
                    ...
                    return ValidateCreditCard(value, type.val());
                    // });
                } else {
                    if (this.optional(element))
                        return "dependency-mismatch";
...
(function($){
$.fn.DigitOnly=function(value,element){
    var digit=$(value);
           return digit.keypress(function(e){
                //$(this).attr("maxlength",maxValue);
            if (e.which != 8 && e.which != 0 && (e.which < 48 || e.which > 57)) {
               $(element).html("Digits Only").css("color", "red").show().fadeOut(1600);
                return false;
            }
            });
};
...
(function($){
$.fn.DigitAndDecimal=function(value,element){
    var digitDecimal=$(value);
           return digitDecimal.keypress(function(e) {
                //$(this).attr("maxlength",maxValue);
            if (e.which != 8 && e.which != 0 && e.which != 46 && e.which != 31 && (e.which < 48 || e.which > 57)) {
                $(element).html("Digits And Decimal Only").css("color", "red").show().fadeOut(1600);
                return false;
            }
        });
};
