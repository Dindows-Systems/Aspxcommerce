...
(function($) {
    $.fn.jcarousel = function(o) {
        //alert("Inside JCrousal" + newObject.height);
        if (typeof o == 'string') {
    ...
    $.jcarousel = function(e, o) {
        ...
        this.clip.addClass(this.className('jcarousel-clip')).css(
        {
            ...
            height: newObject.thumbHeight + 8,
            margin: 10
        }
         );
    ...
    ,
        ...
        pos: function(i) {
            ...
            var j = back ? f : f - 1; var e = null, l = 0, p = false, d = 0, g;
            while (back ? --j >= i : ++j < i) {
                e = this.get(j);
                p = !e.length;
        ...
        callback: function(cb, evt, state, i1, i2, i3, i4) {
            ...
            var $e = $(e).addClass(this.className('jcarousel-item')).addClass(
            this.className('jcarousel-item-' + i)).css({
                'float': 'left',
                'list-style': 'none'
            });
            $e.attr('jcarouselindex', i);
            // alert("Reached the point");

            //  alert("reached");
            $('.jcarousel-item-horizontal').css('height', newObject.thumbHeight);
            $('.jcarousel-item-horizontal').css('width', newObject.thumbWidth);
            $('.jcarousel-item').css('height', newObject.thumbHeight);
            $('.jcarousel-item .jcarousel-item-horizontal .jcarousel-item-1 .jcarousel-item-1-horizontal').css('width', newObject.thumbWidth);
            $('.jcarousel-item .jcarousel-item-horizontal .jcarousel-item-1 .jcarousel-item-1-horizontal').css('height', newObject.thumbHeight);
            return $e;
