    ...
    $.fn.visualize = function(options, container) {
        return $(this).each(function() {
            ...
            var o = $.extend({
                ...
                width: 480, //height of canvas - defaults to table height
                height: 250, //height of canvas - defaults to table height
                appendTitle: true, //table caption text is added to chart
                title: null, //grabs from table caption if null
                appendKey: true, //color key is added to chart
                rowFilter: ' ',
                colFilter: ' ',
                colors: ['#EB9781', '#97D95C', '#DF28EF', '#ee8310', '#8d10ee', '#5a3b16', '#26a4ed', '#f45a90', '#e9e744'],
            ...
            var createChart = {
                pie: function() {
                    ...
                    $.each(memberTotals, function(i) {
                        ...
                        var labelx = Math.round(centerx + Math.sin(sliceMiddle * Math.PI * 2) * (distance)) / 4;
                        var labely = Math.round(centery - Math.cos(sliceMiddle * Math.PI * 2) * (distance)) / 2;
                        x = labely;
                        if (x == labely) {                           
                            if (z == 1) {                              
                                labely += labely + 5;
...
//                            if (h == 1) {
//                                var labeltext = $('<span class="visualize-label">' + labelval + "(A)" + '</span>')
//                            .css(leftRight, 0)
//				        	.css(topBottom, 0);
//                            }
                           //else 
                           if (h == 1) {
                                var labeltext = $('<span class="visualize-label">' + labelval + "(C)" + '</span>')
                            .css(leftRight, -35)
				        	.css(topBottom, 0);
                            }
                            else {
                                var labeltext = $('<span class="visualize-label">' + labelval + "(O)" + '</span>')
                            .css(leftRight, 0)
				        	.css(topBottom, 50);
                            }
            ...
            if(totalYRange!=0){
                var zeroLoc = o.height * (topValue / totalYRange)+10;
            }   
