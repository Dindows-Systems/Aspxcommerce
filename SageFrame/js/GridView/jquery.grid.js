    ...
    $.createGrid = function(t, p) {
        ...
        var g = {
            ...
            newPagination: function() {
                ...
                $(PageNumberMidBg).prepend('<div class="cssClassViewPerPage">View Per Page <select name="rp" id="' + t.id + '_pagesize">+"' + opt + '"</select></div>');
                $(PageNumberMidBg).find('select').change(
					function() {
					    p.page = 1;
					    p.rp = this.value;
					    g.clearAll();
                ...
                $(Pages).prependTo(PageNumberMidBg);
                $(PageOf).prependTo(PageNumberMidBg);
                        ...
                        $(this).find('td').each(function(rcount) {
                            ...
                            switch (cm.coltype) {
                                ...
                                case "image":
                                    ...
                                    previousvalue = previousvalue.replace('uploads', 'uploads/Small');
