...
(function($) {
    ...
    $.fn.jDownload = function(settings) {
        ...
        $(this).live(settings.event, function() {
            ...
            dialog.html('<p>Fetching File...</p><img src="' + settings.root + 'loader.gif" alt="Loading..." />');
                        ...
                        setTimeout(function() {
                            if (data == 'error') {
                                ...
                                if (data != null) {
                                    ...
                                    dialog.html('<p class=\"jDownloadError\">This file is not found!</p>');
                                }
                            }
                        });
                    }
        ...
        function start_download(i) {
            ...
            iframe.attr('src', settings.root + 'DownloadHandler.ashx?action=download&path=' + dialog.data('jDownloadData').filePath);
