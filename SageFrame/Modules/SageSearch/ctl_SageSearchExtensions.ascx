...
<h2 class="cssClassFormHeading">
    <asp:Label ID="lblSageSearchExtensionManagement" runat="server" Text="Search Extension Management"></asp:Label></h2>
<div class="cssClassButtonWrapper" id="actionWrapper" runat="server">
...
<div id="frmWrapper" runat="server">
    <div class="cssClassFormWrapper">
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td width="20%">
                    <asp:Label ID="lblSageFrameSearchTitle" runat="server" Text="Title:" CssClass="cssClassFormLabel"
                        ToolTip="Fill the tile for your search"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtSageFrameSearchTitle" runat="server" ValidationGroup="SearchExtensionValidation" CssClass="cssClassNormalTextBox"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtSageFrameSearchProcedureName" runat="server" ValidationGroup="SearchExtensionValidation" CssClass="cssClassNormalTextBox"></asp:TextBox>
            ...
            <tr>
                <td>
                    <asp:Label ID="lblSageFrameSearchProcedureExecuteAs" runat="server" Text="Execute As:"
                        CssClass="cssClassFormLabel" ToolTip="like dbo"></asp:Label>
                </td>
                <td>
