...
<h2 class="cssClassFormHeading">
    <asp:Label ID="lblMessageTemplateManagement" runat="server" Text="Message Template Management"
        meta:resourcekey="lblMessageTemplateManagementResource1"></asp:Label></h2>
    ...
    <ContentTemplate>
                    ...
                    <div class="cssClassFormWrapper">
                        <h2 class="cssClassFormHeading">
                            <asp:Label ID="lblAddEditMessageTemplate" runat="server" Text="Add/Edit Message Template"
                                meta:resourcekey="lblAddEditMessageTemplateResource1"></asp:Label></h2>
                        <asp:HiddenField ID="hdnMessageTemplateID" runat="server" Value="0" />
                        <table cellspacing="0" cellpadding="0" border="0">
                            <tr>
                                <td>
                                    <asp:Label ID="lblMessageTemplateType1" runat="server" CssClass="cssClassFormLabel"
                                        Text="Message Template Type" meta:resourcekey="lblMessageTemplateType1Resource1"></asp:Label>
                                </td>
                                <td width="5%">
                                    :
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddlMessageTemplateType" ToolTip="Select Message Template Type"
                                        ...
                                        AutoPostBack="True" CssClass="cssClassDropDown" meta:resourcekey="ddlMessageTemplateTypeResource1">
                                    </asp:DropDownList>
                                    <asp:HyperLink ID="hypAddMessageTemplateType" runat="server" Text="Add Message Template Type"
                                        Visible="False" meta:resourcekey="hypAddMessageTemplateTypeResource1" />
                                </td>
                                <td>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label ID="lblFromEmail" runat="server" CssClass="cssClassFormLabel" Text="From Email"
                                ...
                                <td>
                                    <asp:TextBox ID="txtMailFrom" runat="server" ToolTip="From Email Address" ValidationGroup="vdgMessageTemplate"
                                        CssClass="cssClassNormalTextBox" meta:resourcekey="txtMailFromResource1"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtMailFrom"
                                        ErrorMessage="*" ValidationGroup="vdgMessageTemplate" CssClass="cssClasssNormalRed"
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtMailFrom"
                                        ...
                                        CssClass="cssClasssNormalRed" meta:resourcekey="RegularExpressionValidator1Resource1"></asp:RegularExpressionValidator>
                                </td>
                                <td>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label ID="lblSubject" runat="server" CssClass="cssClassFormLabel" Text="Subject"
                                ...
                                <td>
                                    <div style="float: left; width: 321px;">
                                        <asp:TextBox ID="txtSubject" runat="server" ToolTip="Message template subject" ValidationGroup="vdgMessageTemplate"
                                            CssClass="cssClassNormalTextBox" meta:resourcekey="txtSubjectResource1"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtSubject"
                                            ...
                                            CssClass="cssClasssNormalRed" meta:resourcekey="RequiredFieldValidator2Resource1"></asp:RequiredFieldValidator></div>
                                    <div class="cssClassFormLinkButton">
                                        ...
                                        <asp:Label ID="lblAddSubjectMessageToken" runat="server" Text="Add Subject Token"
                                            AssociatedControlID="lnkAddSubjectMessageToken" Style="cursor: pointer;" CssClass="cssClassFormLabel"
                                            meta:resourcekey="lblAddSubjectMessageTokenResource1"></asp:Label></div>
                                </td>
                                <td>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label ID="lblMessage" runat="server" CssClass="cssClassFormLabel" Text="Message"
                                ...
                                <td>
                                    <div class="cssClassFormLinkButton">
                                        ...
                                        <asp:Label ID="lblAddBodyMessageToken" runat="server" Text="Add Body Message Token"
                                            AssociatedControlID="lnkAddBodyMessageToken" Style="cursor: pointer;" CssClass="cssClassFormLabel"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="border: 4px solid #ebcd5f;">
                                        <table cellspacing="0" cellpadding="0" border="0" id="tblTextEditor" runat="server"
                                            width="100%">
                                            <tr runat="server">
                                                <td class="editorheading" style="background-color: #ebcd5f;" runat="server">
                                                    <asp:Label ID="lblEditorTitle" runat="server" CssClass="cssClassFormLabel" Text="Editor:" />
                                                </td>
                                            </tr>
                                            <tr runat="server">
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="lblIsActive" runat="server" CssClass="cssClassFormLabel" Text="Is Active"
        ...
        <asp:Panel ID="pnlAddMessageTokenPopup" runat="server" Style="display: none;" meta:resourcekey="pnlAddMessageTokenPopupResource1">
            <div class="cssClassPopUpPage">
                ...
                <div class="cssClassPopUpColse" id="btnAddMessageTokenCancel" runat="server">
                </div>
                <div class="cssClassPopUp">
                    ...
                    <div class="cssClassBtn">
                        <input type="button" id="btnAddMessageTokenOk" runat="server" value="Add" class="cssClassSubmit" />
                    </div>
                </div>
            </div>
        </asp:Panel>
                    ...
                    <div class="cssClassFormWrapper">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtMessageTemplateType" runat="server" meta:resourcekey="txtMessageTemplateTypeResource1"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                        <div class="cssClassButtonWrapper">
