    ...
    <ContentTemplate>
        ...
        <div id="divEditWrapper" runat="server" class="cssClassEditWrapper">
            <div class="cssClassFormWrapper">
                <table cellspacing="0" cellpadding="0" border="0" width="100%" class="editorborder">
                    <tr>
                        <td>
                            <div class="cssClassHtmlViewBorder">
                                <table cellspacing="0" cellpadding="0" border="0" id="tblTextEditor" runat="server" class="cssClassHtmlViewTable">
                                    <tr>
                                        <td class="editorheading">
                                            <asp:Label ID="lblView" runat="server" CssClass="cssClassFormLabel" Text="Editor:" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            ...
                                            <asp:Label ID="lblError" runat="server" CssClass="cssClasssNormalRed" Visible="false"
                    ...
                    <tr>
                        <td>                        
                            <asp:Label ID="lblPublish" runat="server" CssClass="cssClassFormLabel" Text="Publish" />
                            <asp:CheckBox ID="chkPublish" runat="server" CssClass="cssClassCheckBox" />
                            <asp:Label ID="lblAllowComment" runat="server" CssClass="cssClassFormLabel" Text="Allow Comment" />
                            <asp:CheckBox ID="chkAllowComment" runat="server" CssClass="cssClassCheckBox" />
                        </td>
                    </tr>
                </table>
                <div class="cssClassButtonWrapper">
        ...
        <div id="divAddComment" runat="server" class="cssClassCommentWrapper">
        ...
        <div id="divViewComment" runat="server" class="cssClassCommentWrapper">
        ...
        <div id="divEditComment" runat="server" class="cssClassEditCommentWrapper">
            <div class="cssClassFormWrapper">
                <table id="tblEditComment" runat="server" cellpadding="0" cellspacing="0" border="0" class="cssClassHtmlViewTable">
                 <tr>
                        <td>
                            <asp:Label ID="lblComment" runat="server" CssClass="cssClassFormLabel" Text="Comment">
                            </asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="lblErrorMessage" runat="server" CssClass="cssClasssNormalRed" EnableViewState="false"></asp:Label>                        
                        </td>
                    </tr>
                    <tr id="rowApprove" runat="server">
                        <td>
                            <asp:Label ID="lblApprove" runat="server" CssClass="cssClassFormLabel" Text="Approve"></asp:Label>
                        </td>
                        <td>
                            <asp:CheckBox ID="chkApprove" runat="server" CssClass="cssClassCheckBox"></asp:CheckBox>
                        </td>
                    </tr>
                    <tr id="rowIsActive" runat="server">
                        <td>
                            <asp:Label ID="lblIsActive" runat="server" CssClass="cssClassFormLabel" Text="IsActive" />
                        </td>
                        <td>
                            <asp:CheckBox ID="chkIsActive" runat="server" CssClass="cssClassCheckBox"></asp:CheckBox>
                        </td>
                    </tr>
                </table>
                <div class="cssClassButtonWrapper">
