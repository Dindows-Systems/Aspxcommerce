...
public partial class Modules_Testimonial_TestimonialSetting : BaseAdministrationUserControl
{
    ...
    private void Page_Init()
    {
        ...
        IncludeJs("Testimonial", "Modules/Testimonial/js/jquery.numeric.js");
    }
    ...
    protected void imbSaveSetting_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            ShowMessage(SageMessageTitle.Information.ToString(), SageMessage.GetSageModuleLocalMessageByVertualPath("Modules/Testimonial/ModuleLocalText", "TestimonialSettingSaveSuccessfully"), "", SageMessageType.Success);
        }
        catch (Exception ex)
        {
            ProcessException(ex);
