...
<div class="cssClassFormWrapper">
    <div id="dvAddBtn" runat="server" class="cssClassButtonWrapper">
        <asp:ImageButton ID="imbAddnewInfo" runat="server" OnClick="imbAddnewInfo_Click" />
        <asp:Label ID="lblAddnewinfo" runat="server" Text="Add Testimonial" AssociatedControlID="imbAddnewInfo"></asp:Label>
    </div>
    <div id="divTestimonialForm" runat="server">
        <table id="tblTestimonial" runat="server">
            <tr>
                <td>
                    <asp:Label ID="lblFirstName" runat="server" CssClass="cssClassFormLabel" Text="Name"></asp:Label>
                </td>
                <td>
                    :
                </td>
                <td>
                    <asp:TextBox ID="txtName" CssClass="cssClassNormalTextBox" runat="server"></asp:TextBox>
            ...
            <tr>
                <td>
                    <asp:Label ID="lblAddress" runat="server" Text="Address" CssClass="cssClassFormLabel"></asp:Label>
                </td>
                <td>
                    :
                </td>
                <td>
                    <asp:TextBox ID="txtAddress" runat="server" CssClass="cssClassNormalTextBox"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="lblWeburl" runat="server" Text="Website" CssClass="cssClassFormLabel"></asp:Label>
                </td>
                <td>
                    :
                </td>
                <td>
                    <asp:TextBox ID="txtWeburl" runat="server" CssClass="cssClassNormalTextBox"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="lblImage" runat="server" Text="Image" CssClass="cssClassFormLabel"></asp:Label>
                </td>
                <td>
                    :
                </td>
                ...
                <td colspan="2">
                    <div id="divImage" runat="server">
                        ...
                        <asp:ImageButton ID="imbDeletepic" runat="server" CssClass="cssClassDeleteImage"
                            OnClick="imbDeletepic_Click"></asp:ImageButton>
                    </div>
                </td>
            </tr>
            <tr visible="false">
                <td>
                    <asp:Label ID="lblTitle" runat="server" Text="Title" CssClass="cssClassFormLabel"></asp:Label>
                </td>
                <td>
                    :
                </td>
                <td>
                    <asp:TextBox ID="txtTitle" runat="server" CssClass="cssClassNormalTextBox"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="lblDescription" runat="server" Text="Testimonial" CssClass="cssClassFormLabel"></asp:Label>
                </td>
                <td>
                    :
                </td>
            ...
            <tr>
            <td> <asp:Label ID="lblDate" runat="server" Text="Date" CssClass="cssClassFormLabel"></asp:Label></td>
            <td>
           :
            </td>
            <td>
             <asp:TextBox ID="txtDate" runat="server" CssClass="cssClassNormalTextBox"></asp:TextBox>
             <%--<asp:CalendarExtender ID="cmdNewsCalendar" runat="server" CssClass="CssClassCalendar"
               Enabled="True" PopupButtonID="imbNewsCalender" PopupPosition="BottomLeft" TargetControlID="txtDate" />--%>                                    
                                    <asp:RequiredFieldValidator ID="rfvDate" runat="server" ErrorMessage="Select date !!"
                                        ControlToValidate="txtDate" ValidationGroup="SaveForm"></asp:RequiredFieldValidator>
            </td>
            </tr>
            <tr>
                <td>
                ...
                <td colspan="2">
                    <div class="cssClassButtonWrapper">
                        <asp:ImageButton ID="imbSave" runat="server" ValidationGroup="SaveForm" OnClick="imbSave_Click" />
    ...
    <div id="divGrid" runat="server" class="cssClassGridWrapper">
        <asp:GridView Width="100%" runat="server" ID="gdvTestRecord" GridLines="None" AutoGenerateColumns="False"
            EmptyDataText="..........No Data Found.........." PageSize="10" OnPageIndexChanging="gdvTestRecord_PageIndexChanging"
                            ...
                            <tr id='_<%# (DataBinder.Eval(Container.DataItem,"TestimonialID").ToString())%>'
                                ...
                                <td class="cssClassInfoDetail" colspan="4">
                                    <asp:Panel runat="server" Width="100%">                                       
                                        <p>
                                            <asp:Label ID="lblDescription" runat="server" CssClass="cssClassFormLabel" Text="Testimonial:"></asp:Label>
                                            <asp:Literal ID="ltrDescription" runat="server" Text='<%# (DataBinder.Eval(Container.DataItem,"Testimonial").ToString()) %>'></asp:Literal>
                                        </p>
                                        <p>
                                            <asp:Label ID="lblAddedOn" runat="server" CssClass="cssClassFormLabel" Text="AddedOn:"></asp:Label>
