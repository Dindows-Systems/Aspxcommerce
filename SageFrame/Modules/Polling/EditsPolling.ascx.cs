...
public partial class Modules_Polling_EditsPolling : BaseAdministrationUserControl
{
    ...
    protected void btnSaveIsVisible_Click(object sender, ImageClickEventArgs e)
    {
        ...
        ShowMessage(SageMessageTitle.Information.ToString(), SageMessage.GetSageModuleLocalMessageByVertualPath("Modules/Polling/ModuleLocalText", "SettingSavedSucessfully"), "", SageMessageType.Success);
