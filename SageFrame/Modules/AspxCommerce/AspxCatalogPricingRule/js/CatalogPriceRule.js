 ...
 $(function() {
     ...
     CatalogPricingRule = {
         ...
         init: function() {
             CatalogPricingRule.LoadCatalotStaticImage();
             ...
             $('#CatalogPriceRule-txtValue').live('select', function() {
                 if (catalogDot == true) {
                     catalogCount--;
                 }
                 if (catalogCount == -1) {
             ...
             $('#btnDeleteCatRules').click(function() {
                 ...
                 if (catRule_ids != "") {
                     ...
                     csscody.confirm("<h2>Delete Confirmation</h2><p>Are you sure you want to delete the selected catalog price rule(s)?</p>", properties);
                 } else {
                     csscody.alert('<h2>Information Alert</h2><p>Please select at least one catalog price rule before delete.</p>');
                 }
             });
         ...
         ajaxCall: function(config) {
             $.ajax({
                 type: CatalogPricingRule.config.type,
         ...
         LoadCatalotStaticImage: function() {
         ...
         CatPricingRulesMultipleDelete: function(catRule_ids, event) {
             if (event) {
                 ...
                 this.config.data = JSON2.stringify({ catRulesIds: catRule_ids, storeID: storeId, portalID: portalId, userName: userName, culture: cultureName });
                 ...
                 success: function(data) {
                     ...
                     $.ajax({
                         ...
                         success: function(response) {
                             ...
                             template += '<div class="pricingRuleCategoryList">' + treeHTML + '</div><a href="#" class="cssClassOnClickApply" onclick="CatalogPricingRule.GetCategoryValue(this)"><span class="cssClassRightGreen"></span></a></span></span><span class="cssClassOnClick"><a href="javascript:void(0)" class="cssClassOnClickRemove" title="Remove" onclick="CatalogPricingRule.Delete(this)"><span class="cssClassDelete"></span></a></span></li>';
                             ...
                             $.each(response.d, function(i, item) {
                                 ...
                                 if (item.InputTypeID == 1) //TextBox, Qty
                                 {
                                         ...
                                         for (var i = 0; i < oprts.length; i++) {
                                             if (item.AttributeID != 1 || item.AttributeID != 4) {
                                                 if (item.AttributeID != 15) {
                                                     ...
                                                     if (i < 7) { //To NOT bind {value:8,text:"Equals or Greater Than"},{value:4,text:"Equals or Less Than"},{value:5,text:"Greater Than"},{value:6,text:"Less Than"},
                                                         var val = oprts[i];
                                                         if (i == 0) {
                                                             operators += '<option value="' + val.value + '" selected="selected">' + val.text + '</option>';
                                                         } else {
                                     ...
                                     template += operators + '</select></span></span>&nbsp; <span class="cssClassOnClick"><a href="#" class="cssClassFieldSetLabel"  onclick="CatalogPricingRule.Edit(this)"> {{= valueText }} </a><span class="cssClassElement"><input class="element-value-changer input-text" name="value_{{= RulePath }}" id="value_{{= RulePath }}" title="value"  value="{{= value }}" /><a href="#" class="cssClassOnClickApply" onclick="CatalogPricingRule.GetTextBoxValue(this)"><span class="cssClassRightGreen"></span></a> </span></span>&nbsp; <span class="cssClassOnClick"><a href="#" class="cssClassOnClickRemove" title="Remove" onclick="CatalogPricingRule.Delete(this)"><span class="cssClassDelete"></span></a></span></li>'
                                 ...
                                 } else if (item.InputTypeID == 3) //Date
                                 {
                                     ...
                                     var d = new Date();
                                     template += operators + '</select> </span></span>&nbsp; <span class="cssClassOnClick"><a href="#" class="cssClassFieldSetLabel"  onclick="CatalogPricingRule.Edit(this)"> ' + d.getFullYear() + '/' + (d.getMonth() * 1 + 1) + '/' + d.getDate() + ' </a><span class="cssClassElement"><input class="element-value-changer input-text datepicker" name="value_{{= RulePath }}" id="value_{{= RulePath }}" title="value"  value="{{= value }}" /><a href="#" class="cssClassOnClickApply" onclick="CatalogPricingRule.GetTextBoxValue(this)"><span class="cssClassRightGreen"></span></a> </span></span>&nbsp; <span class="cssClassOnClick"><a href="#" class="cssClassOnClickRemove" title="Remove" onclick="CatalogPricingRule.Delete(this)"><span class="cssClassDelete"></span></a></span></li>'
                                     template = '<script id="PricingRuleTemplate_' + item.AttributeID + '" type="text/html">' + template + '<\/script>';
                                     $('#placeholder-templates').append(template);
                                 } else if (item.InputTypeID == 4 || item.InputTypeID == 6 || item.InputTypeID == 9 || item.InputTypeID == 10) //DropDown
                                 {
                                     ...
                                     template += options + '</select></span></span>&nbsp; <span class="cssClassOnClick"><a href="#" class="cssClassOnClickRemove" title="Remove" onclick="CatalogPricingRule.Delete(this)"><span class="cssClassDelete"></span></a></span></li>'
                                     template = '<script id="PricingRuleTemplate_' + item.AttributeID + '" type="text/html">' + template + '<\/script>';
                                     $('#placeholder-templates').append(template);
                                 } else if (item.InputTypeID == 5 || item.InputTypeID == 11 || item.InputTypeID == 12) //MultiSelect
                                 {
                                     ...
                                     template += options + '</select><a href="#" class="cssClassOnClickApply"></span></span><span class="cssClassOnClick"><a href="javascript:void(0)" class="cssClassOnClickRemove" title="Remove" onclick="CatalogPricingRule.Delete(this)"><span class="cssClassDelete"></span></a></span></li>'
         ...
         SavePricingRule: function() {
             ...
             $.each($('div.cssClassFieldSetContent > ul > li'), function(i, listItem) {
                 ...
                 if (String(type).toLowerCase() == 'attribute') {
                     ...
                     CatalogPricingRule.GetChildPricingRule(lstRuleConditions, (listItem));
                 }
             });
             ...
             this.config.data = JSON2.stringify({ "objCatalogPricingRuleInfo": objCatalogPricingRule.CatalogPricingRuleInfo, storeID: storeId, portalID: portalId, userName: userName, culture: cultureName, "parentID": arrParent });
         ...
         GetChildPricingRule: function(lstRuleConditions, parent) {
             ...
             $.each($(parent).find('> ul > li'), function(i, childListItem) {
                 ...
                 if (String(type).toLowerCase() == 'attribute') {
                     ...
                     CatalogPricingRule.GetChildPricingRule(lstRuleConditions, $(childListItem))
                 }
             });
         },
         ...
         GetPricingRules: function(ruleNm, startDt, endDt, isAct) {
             ...
             $("#gdvCatalogPricingRules").sagegrid({
                 ...
                 buttons: [
                     { display: 'Edit', name: 'edit', enable: true, _event: 'click', trigger: '1', callMethod: 'CatalogPricingRule.EditCatalogPricingRule', arguments: '0' },
                     { display: 'Delete', name: 'delete', enable: true, _event: 'click', trigger: '2', callMethod: 'CatalogPricingRule.DeleteCatalogPricingRule', arguments: '0' }
                 ],
         ...
         DeleteCatalogPricingRule: function(tblID, argus) {
             ...
             case "gdvCatalogPricingRules":
                 if (argus[3]) {
                     var properties = { onComplete: function(e) { CatalogPricingRule.PricingRuleDelete(argus[0], storeId, portalId, userName, cultureName, e); } }
                     csscody.confirm("<h2>Delete Confirmation</h2><p>Are you sure you want to delete this catalog price rule?</p>", properties);
                 }
                 break;
             default:
                 break;
         ...
         PricingRuleDelete: function(priceRuleID, storeId, portalId, userName, cultureName, event) {
             if (event) {
                 this.config.url = this.config.baseURL + "DeletePricingRule";
                 this.config.data = JSON2.stringify({ catalogPricingRuleID: priceRuleID, storeID: storeId, portalID: portalId, userName: userName, culture: cultureName });
         ...
         GetPricingRuleByPricingRuleID: function(pricingRuleID) {
             ...
             this.config.data = JSON2.stringify({ catalogPriceRuleID: pricingRuleID, storeID: storeId, portalID: portalId, userName: userName, culture: cultureName });
         ...
         CheckPriorityUniqueness: function(catalogPriceRuleID) {
             ...
             this.config.data = JSON2.stringify({ catalogPriceRuleID: catalogPriceRuleID, priority: priorityVal, storeID: storeId, portalID: portalId });
         ...
         ajaxSuccess: function(data) {
             ...
             case 0:
                 break;
             case 1:
                 csscody.info('<h2>Successful Message</h2><p>Selected catalog price rule(s) has been deleted successfully.</p>');
                 CatalogPricingRule.GetPricingRules(null, null, null, null);
                 break;
             case 2:
                 var options = '';
                 ...
                 break;
             case 3:
                 csscody.info('<h2>Successful Message</h2><p>Catalog price rule has been deleted successfully.</p>');
                 CatalogPricingRule.GetPricingRules(null, null, null, null);
                 break;
             case 4:
             ...
             case 5:
                 ...
                 case "success":
                     if (catalogEditFlag > 0) {
                         notificationText = "Catalog price rule has been updated successfully."
                     } else {
                         notificationText = "Catalog price rule has been saved successfully."
                     }
                     break;
                 case "notify":
                 ...
                 if (notificationText != "") {
                     ...
                     csscody.info('<h2>Information Message</h2><p>' + notificationText + '</p>');
                     arrParent = new Array();
                     CatalogPricingRule.GetPricingRules(null, null, null, null);
                     CatalogPricingRule.SetTabActive(0, "CatalogPriceRule-TabContainer");
                     CatalogPricingRule.HideShowPrincingRulePanel(true, false);
