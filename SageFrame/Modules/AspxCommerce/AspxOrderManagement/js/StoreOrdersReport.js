...
$(function() {
    ...
    storeOrdersReport = {
        ...
        LoadStoreReportStaticImage: function() {
        ...
        BindOrderDetails: function(customerNm, orderStatusType) {
            ...
            this.config.data = { storeID: storeId, portalID: portalId, cultureName: cultureName, orderStatusName: orderStatusType, userName: customerNm };
            ...
            $("#gdvOrderDetails").sagegrid({
                ...
                colModel: [
                    ...
                    { display: 'Customer ID', name: 'customerID', cssclass: 'cssClassHide', controlclass: '', coltype: 'label', align: 'left', hide: true },
                ...
                buttons: [
                    { display: 'View', name: 'view', enable: true, _event: 'click', trigger: '3', callMethod: 'storeOrdersReport.ViewOrders' }
                ],
                rp: perpage,
        ...
        BindDataForExport: function(msg) {
            var exportData = '<thead><tr><th>Order ID</th><th>Invoice Number</th><th>Customer ID</th><th>Customer Name</th><th>Email</th><th>Order Status</th><th>Grand Total</th><th>Payment Gateway Type Name</th><th>Payment Method Name</th><th>Ordered Date</th></tr></thead><tbody>';
            if (msg.d.length > 0) {
                $.each(msg.d, function(index, value) {
        ...
        ajaxFailure: function(msg) {
            switch (storeOrdersReport.config.ajaxCallMode) {
                case 0:
                    break;
                case 1:
                    csscody.error('<h1>Error Message</h1><p>Failed to load Order status!!!.</p>');
                    break;
                case 2:
                    csscody.error('<h1>Error Message</h1><p>Order details error !!!.</p>');
                    break;
            }
        },
        init: function(config) {
            storeOrdersReport.LoadStoreReportStaticImage();
            storeOrdersReport.HideAll();
