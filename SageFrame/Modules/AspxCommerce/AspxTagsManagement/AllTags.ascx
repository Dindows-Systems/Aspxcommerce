...
<div class="cssClassBodyContentWrapper" id="divShowTagDetails">
    <div class="cssClassCommonBox Curve">
        <div class="cssClassHeader">
            <h2>
                <asp:Label ID="lblTitle" runat="server" Text="All Tags"></asp:Label>
            </h2>
            ...
            <table cellspacing="0" cellpadding="0" border="0" width="100%" class="cssClassPadding">
                <tr>
                    ...
                    <td class="cssClassTableRightCol">
                        <input type="text" id="txtTag" name="Tag" class="cssClassNormalTextBox required"
                            maxlength="20" />
                    </td>
                </tr>
                <tr>
...
<div class="divTagedItemsDetails" id="divTagedItemsDetails" style="display: none">
    <div class="cssClassCommonBox Curve">
        <div class="cssClassHeader">
            <h2>
                <asp:Label ID="lblTagViewHeading" runat="server"></asp:Label></h2>
        </div>
        <div class="cssClassGridWrapper">
            <div class="cssClassGridWrapperContent">
