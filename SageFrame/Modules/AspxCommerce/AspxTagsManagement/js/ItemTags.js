...
$(function() {
    ...
    ItemTags = {
        ...
        BindItemTagsExportData: function(data) {
            var exportData = '<thead><tr><th>Item Name</th><th>Number Of Unique Tags</th><th>Number Of Tags</th></tr></thead><tbody>';
            if (data.d.length > 0) {
        ...
        BindItemTagsDetails: function() {
            ...
            $("#gdvItemTag").sagegrid({
                ...
                buttons: [
                    { display: 'View', name: 'showtags', enable: true, _event: 'click', trigger: '1', callMethod: 'ItemTags.ShowItemTagsList', arguments: '1,2,3' }
    			    ],
                rp: perpage,
        ...
        GetItemTagDetailListForExport: function() {
            ...
            this.config.data = JSON2.stringify({ offset: 1, limit: null, storeId: storeId, portalId: portalId, itemID: tagedItemID });
            this.config.ajaxCallMode = 2;
            this.ajaxCall(this.config);
        },
        BindShowCustomreTagListExportData: function(data) {
            var exportData = '<thead><tr><th>Tag Name</th><th>Tag Use</th></tr></thead><tbody>';
            if (data.d.length > 0) {
                $.each(data.d, function(index, value) {
