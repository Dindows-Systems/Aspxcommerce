        ...
        var AspxOrder = {
            ...
            ajaxSuccess: function(data) {
                switch (AspxOrder.config.ajaxCallMode) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        document.location = AspxCommerce.utils.GetAspxRedirectPath() + "Cash-On-Delivery-Success.aspx";
                        break;
                    case 4:
                        document.location = AspxCommerce.utils.GetAspxRedirectPath() + "Cash-On-Delivery-Success.aspx";
                        break;
            ...
            getSession: function(Key) {
                ...
                var OrderDetails = {
                    ...
                    PaymentInfo: { PaymentMethodName: paymentMethodName, PaymentMethodCode: paymentMethodCode, CardNumber: "", TransactionType: creditCardTransactionType,
                        CardType: CardType, CardCode: "", ExpireDate: "", AccountNumber: accountNumber, RoutingNumber: routingNumber, AccountType: accountType, BankName: bankName,
                    ...
                    OrderDetailsInfo: { SessionCode: '', IsGuestUser: false, InvoiceNumber: "", TransactionID: 0, GrandTotal: amount, DiscountAmount: CheckOut.UserCart.TotalDiscount, CouponCode: CheckOut.UserCart.couponCode, PurchaseOrderNumber: 0,
