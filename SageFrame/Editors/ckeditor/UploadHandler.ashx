 ...
 public class UploadHandler : IHttpHandler
    {
        ...
        {           
            ...
            string strBaseLocation = HttpContext.Current.Server.MapPath("~/Upload/image/");
            ...
            HttpContext.Current.Response.Write("<script>window.parent.CKEDITOR.tools.callFunction(" + funcNum + ", '" + appPath + "'+'/Upload/image/" + fileName + "', 'Uploaded successfully'); self.close();</script>");
